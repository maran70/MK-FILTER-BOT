...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
            ...
            InlineKeyboardButton('✇ Jᴏɪɴ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ ✇', url="https://t.me/shettymoviess")
        ]]
    ...
    if len(message.command) != 2:
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        m=await message.reply_sticker("CAACAgUAAxkBAAPXZ0SJ4NJnrjVMCDSLr-6BhrP_zywAAtYFAALxioFXNwaRG2wh-DkeBA") 
            ...
            try:
                ...
                if STREAM_MODE == True:
                    button = [[
                        ...
                        InlineKeyboardButton('Mᴏᴠɪᴇs Rᴇǫᴜᴇsᴛ Gʀᴏᴜᴘ', url="https://t.me/Movies_request_group_tamil")
                    ],[
                    ...
                    button = [[
                        ...
                        InlineKeyboardButton('Mᴏᴠɪᴇ Rᴇǫᴜᴇsᴛ Gʀᴏᴜᴘ', url="https://t.me/Movies_request_group_tamil")
                    ]]
        ...
        for file in files:
            ...
            if not await db.has_premium_access(message.from_user.id):
                if not await check_verification(client, message.from_user.id) and VERIFY == True:
                    ...
                    await message.reply_text(
                        text="<b>🫵நீங்கள் [ 𝗩𝗲𝗿𝗶𝗳𝘆 ]செய்வதன் மூலம் நீங்கள் விரும்பும் படங்களை ஒரு நாள் முழுவதும்  விளம்பரம் இல்லாமல் பெற்றுக் கொள்ளலாம் \n\n𝗬𝗼𝘂 𝗡𝗼𝘁 𝗩𝗲𝗿𝗶𝗳𝗶𝗲𝗱 𝗧𝗼𝗱𝗮𝘆 𝗞𝗶𝗻𝗱𝗹𝘆 𝗩𝗲𝗿𝗶𝗳𝘆 𝗡𝗼𝘄✨!</b>",
                        protect_content=True,
                        reply_markup=InlineKeyboardMarkup(btn)
                    )
                    return
            if STREAM_MODE == True:
                button = [[
                    ...
                    InlineKeyboardButton("Mᴏᴠɪᴇs Rᴇǫᴜᴇsᴛ Gʀᴏᴜᴘ", url="t.me/Movies_request_group_tamil")
                ],[
                ...
                button = [[
                    ...
                    InlineKeyboardButton("Mᴏᴠɪᴇs Rᴇǫᴜᴇsᴛ Gʀᴏᴜᴘ", url="t.me/Mᴏᴠɪᴇ Rᴇǫᴜᴇsᴛ Gʀᴏᴜᴘ")
                ]]
            msg = await client.send_cached_media(
                chat_id=message.from_user.id,
                file_id=file_id,
